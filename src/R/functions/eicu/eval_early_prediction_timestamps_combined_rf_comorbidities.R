...
eval.early.prediction.timestamps.combined.rf.comorbidities = function(model, data, sampling.data, comorbidities, means, min.time = NULL, max.time = NULL, timestamps = NULL) {
    ...
    a = eval.table.with.sofa.comorbidities(timestamps,data,comorbidities)

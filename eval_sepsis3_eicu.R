...
source("eicu_functions/eval_max_in_past.R")
source("eicu_functions/sum_in_past.R")

clinical.data = readRDS("eicu/clinical_data_cleaned.rds")
...
saveRDS(sofa.scores, file("eicu/sofa_scores.rds"))
